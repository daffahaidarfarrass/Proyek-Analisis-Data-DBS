...
# Visualisasi klaster penyewaan berdasarkan musim

st.subheader("Bicycle Rental Cluster Based on Season")
# Menentukan batas klaster berdasarkan kuartil
q1, q3 = day["cnt"].quantile([0.33, 0.67])

# Menentukan kategori klaster
def kategori_penyewaan(cnt):
    if cnt <= q1:
        ...
        return "Tinggi"
# Menambahkan kolom kategori penyewaan
day["klaster_penyewaan"] = day["cnt"].apply(kategori_penyewaan)
# Mapping musim
season_map = {1: 'Spring', 2: 'Summer', 3: 'Fall', 4: 'Winter'}

# Membuat figure untuk Streamlit
fig, ax = plt.subplots(figsize=(10, 5))
sns.countplot(x="season", hue="klaster_penyewaan", data=day, palette="coolwarm", ax=ax)

# Mengubah label sumbu x sesuai dengan season_map
ax.set_xticks([0, 1, 2, 3])
ax.set_xticklabels(season_map.values())

ax.set_title("Distribusi Klaster Penyewaan Berdasarkan Musim")
ax.set_xlabel("Musim")
